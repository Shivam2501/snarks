...
public class AES128 extends CircuitGenerator {
  ...
  public void __defineVerifiedWitnesses() {
    ...
    plaintext = UnsignedInteger.createVerifiedWitnessArray(this, plaintext.length, 8);
    key = UnsignedInteger.createVerifiedWitnessArray(this, key.length, 8);
  ...
  private UnsignedInteger gal_mul_const(UnsignedInteger x, int c) {
    ...
    for (int counter = 0; counter < 8; counter += 1) {
      ...
      {
        Bit bit_l0c0jb = hi.copy();
        boolean c_l0c0jb = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_l0c0jb);
        if (c_l0c0jb) {
          if (bit_l0c0jb.getConstantValue()) {
            x.assign(tmp, 8);
          } else {
          ...
          ConditionalScopeTracker.push(bit_l0c0jb);
          x.assign(tmp, 8);
